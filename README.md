...
_Note : this repository contains only the `cpp_03` module. It is part of the global [cpp_modules](https://github.com/bibickette/cpp_modules) repository, which regroups all C++ modules._

1. Clone `cpp_03` in a folder first : `git clone https://github.com/bibickette/cpp_03.git`
...
_Project validation date : March 17, 2025_
